...
class Checker {
    static def isApk(Project project) {
        return project.getPlugins().hasPlugin('com.android.application')
    }

    static def isAar(Project project) {
        return project.getPlugins().hasPlugin('com.android.library')
    }

    static def isJar(Project project) { return project.getPlugins().hasPlugin('java-library') }

    static def isJava(Project project) { return project.getPlugins().hasPlugin('java') }

    static def isKotlin(Project project) { return project.getPlugins().hasPlugin('kotlin') }
