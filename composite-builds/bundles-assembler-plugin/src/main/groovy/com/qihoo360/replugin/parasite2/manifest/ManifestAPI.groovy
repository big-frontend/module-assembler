...
package com.qihoo360.replugin.parasite2.manifest
...
//                instantRunManifestOutputFile = new File(processManifestTask.getInstantRunManifestOutputDirectory(), "AndroidManifest.xml")
                def dir = processManifestTask.multiApkManifestOutputDirectory
                ...
                dir = processManifestTask.multiApkManifestOutputDirectory
                if (dir instanceof File || dir instanceof String) {
