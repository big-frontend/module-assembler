...
package com.qihoo360.replugin.parasite2.debugger
...
//        def globalScope = variant.componentProperties.globalScope
//        def variantConfiguration = variantData.variantConfiguration
//        String archivesBaseName = globalScope.getProjectBaseName();
...
//        String unsigned = (variantData.variantDslInfo.getSigningConfig() == null
//                ? "-unsigned.apk"
//                : ".apk");
