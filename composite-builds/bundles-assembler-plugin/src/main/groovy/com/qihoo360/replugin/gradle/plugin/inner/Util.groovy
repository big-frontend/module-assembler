...
public class Util {
    ...
    static getClassPaths(Project project, def globalScope, Collection<TransformInput> inputs, Set<String> includeJars, Map<String, String> map) {
        def classpathList = []
        def androidJar = com.qihoo360.replugin.util.Util.findAndroidJarPath(project,project.android.defaultConfig.targetSdkVersion.getApiLevel())
        // android.jar
        classpathList.add(androidJar)
