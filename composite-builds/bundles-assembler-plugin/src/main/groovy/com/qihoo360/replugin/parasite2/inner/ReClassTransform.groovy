...
import com.qihoo360.replugin.parasite2.injector.IClassInjector
import com.qihoo360.replugin.parasite2.injector.Injectors
...
//                   boolean localisIncremental) throws IOException, TransformException, InterruptedException {
//        if (!isIncremental()) {
//            try {
...
//    }
    ...
    def repackage() {
        ...
        includeJars.each {
            ...
            Util.zipDir(project, dirAfterUnzip, JarAfterzip)
