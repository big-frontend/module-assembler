...
import com.qihoo360.replugin.parasite.injector.IClassInjector
import com.qihoo360.replugin.parasite.injector.Injectors
...
class ReClassTransform extends Transform {
    ...
    ReClassTransform(Project p, ParasiteConfig config) {
        this.project = p
        this.config = config
