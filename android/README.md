...
利用工具(tools/module-manager-plugin-1.0.1.jar)来选择模块，对于fwk组必须不被exclude，因为作为基础服务要集成到项目中，exclude只会对app framework以上的模块，如果有兴趣了解工具的源码，来这里[康康](https://github.com/big-frontend/module-assembler/tree/main/module-manager-intellij-plugin), 来点个![img](https://github.com/big-frontend/module-assembler/blob/main/b/img.png)


![picture](https://github.com/big-frontend/module-assembler/blob/main/b/tools/bundles.png)
