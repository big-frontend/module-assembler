 ...
 * the License.
 */
package com.qihoo360.replugin.host.creator.impl.java
...
public class RePluginHostConfigCreator implements IFileCreator {
    ...
    RePluginHostConfigCreator(def project, def variant, def cfg) {
        ...
        fileDir = new File("${project.buildDir}/generated/source/buildConfig/$flavor/$buildType", HOST_CONFIG_PATH)
    }
